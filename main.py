...
def add_numbers():
    number_input = st.session_state["number_input"].strip()  # Captura a entrada atual do usuário
    if number_input:
        try:
...
# Campo de entrada para adicionar números separados por vírgula ou individualmente com on_change
st.text_input(
